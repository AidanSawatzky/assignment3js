...
let costPerDay = 35; // Cost per day
let daysSelected = new Set(); // Array to store selected days
const dayButtons = [
...
const fullDayButton = document.getElementById('full'); // Full day selection button
const halfDayButton = document.getElementById('half'); // Half day selection button
...
function calculateTotalCost() {
    const totalCost = costPerDay * daysSelected.size;
